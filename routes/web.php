...
// Route::get('login', 'installController@index');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('/airtime', 'BillsController@airtimeindex')->name('airtime');
    Route::any('/airtime/step1', 'BillsController@airtimestep1')->name('airtime.step1');
